...
public class CouleursAnneaux {
    ...
    public static Map<CouleurResistance, Integer> COULEURS_ANNEAU_2 = new HashMap<>() {{
        put(CouleurResistance.NOIR, 0);
        put(CouleurResistance.MARRON, 1);
        put(CouleurResistance.ROUGE, 2);
        put(CouleurResistance.ORANGE, 3);
    ...
    public static Map<CouleurResistance, Integer> COULEURS_ANNEAU_3 = new HashMap<>() {{
        put(CouleurResistance.NOIR, 0);
        put(CouleurResistance.MARRON, 1);
        put(CouleurResistance.ROUGE, 2);
        put(CouleurResistance.ORANGE, 3);
    ...
    public static Map<CouleurResistance, Double> COULEURS_ANNEAU_TOLERANCE = new HashMap<>() {{
